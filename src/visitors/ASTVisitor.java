...
public interface ASTVisitor<T> {
  ...
  default T visit(ASTNode node) {
    ...
    else if (node instanceof ClazzDefNode)
      return visit((ClazzDefNode) node);
    else if (node instanceof IfStmtNode)
      return visit((IfStmtNode) node);
    else if (node instanceof ElifStmtNode)
      return visit((ElifStmtNode) node);
    else if (node instanceof WhileStmtNode)
      return visit((WhileStmtNode) node);
    else if (node instanceof FuncDefNode)
      return visit((FuncDefNode) node);
    else if (node instanceof IDNode)
      return visit((IDNode) node);
    else if (node instanceof LitNode<?>)
      return visit((LitNode<?>) node);
