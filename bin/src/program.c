...
__MPyObj *func_A_foo(__MPyObj *args, __MPyObj *kwargs)
{
	...
	__mpy_obj_ref_dec(__mpy_call(print, __mpy_tuple_assign(0, __mpy_obj_init_str_static("foo"), __mpy_obj_init_tuple(1)), NULL));
...
int main()
{
	...
	printf("%s\n", __mpy_type_name(__mpy_call(A, __mpy_obj_init_tuple(0), NULL)->__MPyFunc_type));
